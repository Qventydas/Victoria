...
bwoink-system-introductory-message =
    Пожалуйста, детально опишите вашу проблему. Учтите, что член администрации, который решает проблему, может не иметь информации о ситуации из первых рук.
    Сообщения о багах следует отправлять в Discord сервера. Тем не менее, если баг серьёзно мешает вы можете попросить исправить его последствия.
    Использование без везкой причины может повлечь наказание.
