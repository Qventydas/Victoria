...
ent-DrinkLemonLimeCranberryCan = банка клюквенного лимон-лайма
    .desc = Вы все хотите клюквенный смайт? Любимый напиток администраторов во всём мире. напиток в модерации. Лимитированная праздничная серия!
