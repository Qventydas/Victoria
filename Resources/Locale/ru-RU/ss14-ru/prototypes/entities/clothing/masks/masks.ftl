...
ent-ClothingMaskBlushingClown = Стесняющаяся маска клоуна
    .desc = Маска для стесняющихся клоунов.
ent-ClothingMaskBlushingMime = Стесняющаяся маска мима
    .desc = Маска для стесняющихся мимов.
