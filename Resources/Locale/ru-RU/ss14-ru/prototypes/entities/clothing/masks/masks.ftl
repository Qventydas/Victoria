...
ent-ClothingMaskSexyClown = Стесняющаяся маска клоуна
    .desc = Маска для сесняющихся клоунов.
ent-ClothingMaskSexyMime = Стесняющаяся маска мима
    .desc = Маска для сесняющихся мимов.
