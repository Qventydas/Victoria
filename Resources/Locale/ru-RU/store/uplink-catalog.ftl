...
uplink-fake-mindshield-name = Лже-Щит разума
uplink-fake-mindshield-desc = Переключаемый имплант, способный мимкрировать под настоящий имплант, обманывая людей с визорами, показывающими его наличие. (Фирменный имплант НТ не в комплекте)