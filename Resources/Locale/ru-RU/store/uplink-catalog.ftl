...
uplink-access-breaker-name = Дизруптор аутентификации
uplink-access-breaker-desc = Взломанный конфигуратор доступа, собрат ЕМАГа. Это устройство способно взламывать шлюзы и стирать оограничения досутпа с различного оборудования. Перезаряжается автоматически.
...
uplink-radio-implanter-desc = Имплантирует радио Синдиката, позволяя болтать с коллегами и друзьями без гарнитуры.
# Bundles
...
uplink-fake-mindshield-name = Лже-защита разума
uplink-fake-mindshield-desc = Переключаемый имплант, маскирующийся под настоящий имплант,позволяющий обмануть пользователей визоров, показывающих его наличие.(Имплантер НТ не в комплекте.)