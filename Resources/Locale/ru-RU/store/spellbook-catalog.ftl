...
spellbook-voidapplause-desc = Поменяйтесь местами с целью.
...
spellbook-animate-description = Вдохните жизнь в неживой объект!
...
spellbook-staff-animation-description = Вдохните жизнь в неживые предметы!
