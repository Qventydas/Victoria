...
trait-monochromancy-desc = Вы совершенно не различаете цвета. Весь мир для вас- оттенки серого.
...
trait-painnumbness-name = Нечуствительность к боли
trait-painnumbness-desc = Вы не чувствуете боль. Кажется даром, но в реальности является проклятием.
