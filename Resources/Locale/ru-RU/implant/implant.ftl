...
action-name-toggle-fake-mindshield = [color=green]Переключить лже-щит разума[/color]
action-description-toggle-fake-mindshield = Выключить/включить лже-щит разума
