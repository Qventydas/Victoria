...
action-name-toggle-fake-mindshield = [color=green]Переключить фальшивую защиту разума[/color]
action-description-toggle-fake-mindshield = Включите или выключите вашу фейковый имплант защиты разума.
