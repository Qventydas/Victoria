#--------------------бот грузчик космологистики--------------------
chat-emote-name-coffe = со вкусом пьёт кофеёк
...
#--------------------бот охранник космологистики--------------------
chat-emote-name-bolt = щёлкает затвором
chat-emote-name-cartridges = проверяет патроны в магазине
chat-emote-name-gear = поправляет снаряжение
# chat-emote-name-looks = пристально оглядывает вещи вокруг
# chat-emote-name-listening = внимательно слушает гарнитуру
#--------------------бот инженер космологистики--------------------
chat-emote-name-checked = сверяется с чертежами
chat-emote-name-measurement = делает измерения
# chat-emote-name-counts = задумчиво считает в уме
# chat-emote-name-twists = подкручивает механизм
# chat-emote-name-checks = проверяет технику
