...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            ISharedSponsorsManager? sponsorsManager) //Sponsor think
        {
            ...
            // SPONSOR THINK START
            if (_sponsorsManager is ISponsorUpdateInvoker sponsorUpdateInvoker)
            {
                Logger.Info("Registered Sponsor Update invoker");
                sponsorUpdateInvoker.OnSponsorInfoUpdated += () =>
                {
                    Save?.Invoke();
                };
            }
