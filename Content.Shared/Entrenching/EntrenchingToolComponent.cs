...
public sealed partial class EntrenchingToolComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier DigSound = new SoundCollectionSpecifier("EntrenchingThud", AudioParams.Default.WithVolume(-3));

    [DataField, AutoNetworkedField]
    public SoundSpecifier FillSound = new SoundCollectionSpecifier("EntrenchingRustle", AudioParams.Default.WithVolume(-6));
}
